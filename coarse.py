...
'''
# The only thing that needs changing when switching between training coarse or fine-scale is  ----- OPTIMIZER / OPTIMIZER_FS -----
# And RMSElog() argument is either -- depth_map -- or -- depth_map_fs --
'''
